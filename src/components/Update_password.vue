    ...
    <div id='all'>
        <div id="update_title">
            ...
            <div style="margin-top:50px">
                <span class="option_action" @click="change_page(1)">注册</span>
                <span class="option_action" @click="change_page(2)">忘记密码</span>
            </div>
        </div>
        <!-- option_action=1为注册页面 -->
        <div v-show="this.option_action==1">
            <div id='update_text'>
                <div id="tips"><img src="../assets/tip.png" alt="" style="width:22px">请输入需注册的邮箱或手机号</div>
                ...
                <div id='update_text'>
                    <div class="login_input">
                    <span>密码：</span><input type="password" ref="password" placeholder="请输入密码" autocomplete="off" maxlength='12'>
                </div><br/>
                </div>
        ...
        <div v-show="this.option_action==2">
            ...
            <div id='update_text' v-show="this.code_status==2">
                ...
                <div class="login_input">
                    <span>确认密码：</span><input type="password" ref="confirm_password" placeholder="请再次输入密码" autocomplete="off" maxlength='12'>  
                </div>
...
export default {
  ...
  methods:{
      /* 
      acition=1显示注册页面，action=2显示忘记密码页面
      */
    change_page(action){
        if(action==1){
